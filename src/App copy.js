      ...
      <Router>
        <div className="app-container">
          <Routes>
            ...
            <Route path="/wildlifedetail" element={<WildlifePageDetailsPage />}></Route>
            <Route path="/wildlife" element={<WildlifePage />}></Route>
            <Route path="/explorepark" element={<ExploreParksPage />}></Route>
